  ...
  return <>
    ...
    <header className="site-header wrap">
      ...
      <nav className="links" aria-label="Primary navigation">
        <a href="/shop">Shop</a><a href="/science">Our science</a><a href="/story">Our story</a><a href="/journal">Journal</a><a href="/checkout">Cart</a>
      </nav>
    </header>
    ...
    <main>
      <section className="hero wrap">
        <div className="hero-copy">
          ...
          <div className="hero-actions"><a className="button" href="/shop">Explore materials</a><a className="text-link" href="/science">Our science <span>↗</span></a></div>
        </div>
        <div className="hero-art hero-editorial" aria-hidden="true"><img src="/images/hero.png" alt="" className="hero-editorial-image" /></div>
      </section>

      <section className="compliance wrap">
        <div><strong>01</strong><span>Research use only</span></div><div><strong>02</strong><span>Clear specifications</span></div><div><strong>03</strong><span>No personal-use guidance</span></div>
      </section>
      ...
      <section className="statement wrap"><div className="eyebrow">The VOIÉLA standard</div><h2>Nothing hidden.<br/><em>Nothing implied.</em></h2><p>Our storefront is intentionally simple: products are presented strictly as research materials, without dosing instructions, treatment claims, or personal-use recommendations.</p><a className="button button-light" href="/story">Our story</a></section>
