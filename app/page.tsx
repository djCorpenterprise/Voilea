      ...
      <section className="hero wrap">
        ...
        <div className="hero-art" aria-hidden="true">
          <div className="hero-vials">
            <div className="hero-vial hero-vial-back"><div className="hero-vial-cap"/><div className="hero-vial-body"><span>VOIÉLA</span><strong>RT-3</strong><small>RUO</small></div></div>
            <div className="hero-vial hero-vial-front"><div className="hero-vial-cap"/><div className="hero-vial-body"><span>VOIÉLA</span><strong>RESEARCH</strong><small>RUO</small></div></div>
          </div>
