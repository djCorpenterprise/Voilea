  ...
  return <>
    ...
    <main>
      <section className="luxury-hero">
        <img src="/images/heronew1.png?v=1" alt="VOIÉLA editorial presentation" />
      ...
      <section className="atmosphere-banner"><img src="/images/hero.png" alt="VOIÉLA stone, glass, and botanical editorial setting" /><div className="atmosphere-copy"><div className="eyebrow">A more considered approach</div><h2>Quietly<br/><em>distinctive.</em></h2></div></section>

      <section className="luxury-feature luxury-feature-reverse wrap"><div className="luxury-feature-image"><img src="/images/ghk1.png" alt="VOIÉLA editorial brand setting" /></div><div className="luxury-feature-copy"><div className="eyebrow">VOIÉLA</div><h2>Considered<br/><em>from every angle.</em></h2><p>Soft textures, sculptural forms, and a restrained visual language bring the collection together.</p><a className="text-link" href="/shop">Explore the collection <span>↗</span></a></div></section>

      <section className="luxury-closing"><img src="/images/gv1.png" alt="VOIÉLA luxury editorial setting" /><div className="luxury-closing-copy"><div className="eyebrow">VOIÉLA</div><h2>Science.<br/><em>Presented beautifully.</em></h2><a className="button button-light" href="/shop">Shop collection</a></div></section>
    </main>
